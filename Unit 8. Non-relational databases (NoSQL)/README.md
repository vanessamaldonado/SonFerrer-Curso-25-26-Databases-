...
### 1. Manage information stored in non-relational databases, evaluating and utilizing the capabilities provided by the database management system.
    ...
    - Identify the elements used in these databases.
    - Identify different methods of information management according to the type of non-relational database.
    - Use database management system tools to manage stored information.
